...
export default function Layout({ children }: LayoutProps) {
  ...
  const navigation = [
    ...
    },
    {
      ...
      roles: ["прораб", "логист", "руководитель", "финансовый", "генеральный", "супер_юзер"],
    },
    {
      name: "Перевозчики",
      href: "/carriers",
      ...
      roles: ["логист", "руководитель", "финансовый", "генеральный", "супер_юзер"],
    },
    {
      name: "Маршруты",
      href: "/routes",
    ...
    },
    {
      ...
      roles: ["руководитель", "финансовый", "генеральный", "супер_юзер"],
    },
    {
